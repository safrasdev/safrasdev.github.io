...
const TextPressure = ({
  ...
  const setSize = useCallback(() => {
    ...
    // Adjusted sizing factor so it fits nicely inside the container instead of cutting off
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full overflow-visible bg-transparent">
      ...
      <h1
        ref={titleRef}
        className={`text-pressure-title ${className} ${flex ? 'flex justify-between' : 'flex justify-center gap-[0.02em]'
